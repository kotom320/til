...
tags:
  ...
  - react-svgr
summary: >-
  Vite 환경에서 public 디렉토리의 에셋을 import할 수 없는 원인을 분석하고, 에셋을 src로 되돌려 문제를 해결한 과정을
  정리한다.
---
...
```
import ClientAIcon from '@assets/clients/client-a/logo_header.svg?react'
```
...
```
public/assets/clients/client-a/logo_header.svg
```
...
```
import LogoHeader from '@assets/clients/client-a/logo_header.svg?react' // 오류
```
...
```
src/assets/clients/client-a/logo_header.svg
```
...
```
import LogoHeader from '@assets/clients/client-a/logo_header.svg?react' // 정상 동작
```
